 ...
 *
 * Usage:
 *   npx get-bio-done                  # Interactive
 *   npx get-bio-done --local          # Install into current project
 *   npx get-bio-done --global         # Install globally
 *   npx get-bio-done --uninstall      # Remove
 */
...
const BRAND = {
  name: "get-bio-done",
  displayName: "Get Bio Done",
  prefix: "gbd",
  pyModule: "gbd",
  homeDir: ".gbd",
  homeDirEnv: "GBD_HOME",
  description: "AI copilot for autonomous bioinformatics research",
  repo: "https://github.com/JesseRWeigel/get-bio-done",
};
