...
Run diagnostic checks on the GBD project and optionally fix issues.

### Checks

1. **Required files**: .gbd/ directory exists, STATE.md, state.json, ROADMAP.md, config.json
...
- Initialize missing .gbd/ subdirectories
