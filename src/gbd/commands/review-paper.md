...
1. **Existence check**: Does the cited work exist? Verify against:
   - PubMed, GEO (Gene Expression Omnibus), SRA (Sequence Read Archive), UniProt, and Google Scholar
...
Load convention locks from .gbd/conventions.json.
...
Spawn gbd-referee with the manuscript. The referee runs 5 independent review perspectives:
...
#### 4f. Reproducibility Review
- Are experimental protocols detailed enough to reproduce?
- Are biological replicates vs technical replicates distinguished?
- Are statistical tests appropriate for the data type?
- Are all sequencing/omics data deposited with accession numbers?
