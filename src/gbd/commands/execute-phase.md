...
Read `{GBD_INSTALL_DIR}/specs/workflows/execute-phase-workflow.md` first. Do NOT improvise.
...
### Pre-execution
1. Load state via gbd-state
2. Check conventions via gbd-conventions
...
2. For each plan/task in the wave (parallel):
   a. Spawn gbd-executor subagent with task context
...
4. Run inter-wave verification if configured (QC/convention checks)
5. Update STATE.md

### Post-Phase Verification
After all waves complete:
1. Spawn gbd-verifier with all phase artifacts
